...
- [ ] T012 [P] [US1] Write §2.8 Lockdown Mode, §2.9 Recovery Mode Password in `docs/HARDENING.md` -- Lockdown Mode compatibility warning with Colima/Docker/n8n web UI, recovery mode `[EDUCATIONAL]` tag per plan.md Article V exceptions, startup security levels per FR-076
